...
local default_effects_blacklist = {
	true
};
...
local function is_character_attacker(pb, character)
	...
	for i = 0, (pb:secondary_attackers()):num_items() - 1 do
		if ((pb:secondary_attackers()):item_at(i)):command_queue_index() == character:command_queue_index() then
			return true;
		end;
	end;
	return false;
...
cm:add_first_tick_callback(function()
	core:add_listener("CheckWoundedFactionLeaders", "FactionTurnStart", function(context)
