    ...
    if current_faction_name ~= "rebels" then
        cm:callback(function()
            ...
            elseif combined_difficulty == -3 then -- Legendary
                ...
                mod_construction = 2.2
                mod_recruit_cost = 2.2
                mod_tax_rate = 2.2
                mod_growth = 2.2
                mod_battle_loot = 2.2
            ...
            if (current_faction:is_vassal_of(human_faction) == true or current_faction:allied_with(human_faction) == true) then
                ai_buff_level = ai_buff_level / 1.25
            end
            ...
            --  AI Faction: " .. current_faction_name .. " |
            if (current_faction_name == "wh_main_emp_empire") or (current_faction_name == "wh_dlc07_vmp_von_carstein") then
                jlog("Turn: # " .. turn_number .. " |  Difficulty: " .. player_difficulty .. " | Player Score: " .. player_score .. "| AI Buff Level: " .. ai_buff_level .. " | Income: " .. "+" ..
                         effect_strength_tax_rate .. "%" .. " | Growth: " .. "+" .. effect_strength_growth .. " | Construction Cost: " .. effect_strength_construction .. "%" .. " | Loot: " .. "+" ..
                         effect_strength_battle_loot .. "%" .. " | Rank: " .. "+" .. recruit_rank .. " | Unit XP Per Turn: " .. "+" .. xp_gain_per_turn .. " | Replenishment: " .. "+" ..
