    ...
    if current_faction_name ~= "rebels" then
        cm:callback(function()
            ...
            effect_bundle:add_effect("wh_main_effect_force_all_campaign_experience_base_all", "faction_to_force_own",
                recruit_rank)
            effect_bundle:add_effect("wh_main_effect_force_all_campaign_post_battle_loot_mod", "faction_to_faction_own",
            ...
            if (cm:get_saved_value("jdyndif_enable_replenishment")) then
                effect_bundle:add_effect("wh2_main_effect_replenishment_characters", "faction_to_force_own",
                    replenishment_bonus)
                effect_bundle:add_effect("wh_main_effect_force_all_campaign_replenishment_rate", "faction_to_force_own",
                    replenishment_bonus)
            end
            ...
            if (current_faction_name == "wh_main_emp_empire") or (current_faction_name == "wh_dlc07_vmp_von_carstein") then
                jlog("Turn: # " .. turn_number .. " |  Difficulty: " .. player_difficulty .. " | Player Score: " ..
                         player_score .. "| AI Faction: " .. tostring(current_faction_name) .. " | AI Buff Level: " .. ai_buff_level .. " | Income: " .. "+" ..
                         effect_strength_tax_rate .. "%" .. " | Growth: " .. "+" .. effect_strength_growth ..
                         " | Construction Cost: " .. effect_strength_construction .. "%" .. " | Loot: " .. "+" ..
                         effect_strength_battle_loot .. "%" .. " | Rank: " .. "+" .. recruit_rank ..
                         " | Unit XP Per Turn: " .. "+" .. xp_gain_per_turn .. " | Replenishment: " .. "+" ..
