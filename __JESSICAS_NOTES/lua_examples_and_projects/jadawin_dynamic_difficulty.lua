    ...
    elseif (subculture == "wh_dlc05_sc_wef_wood_elves") then
        ...
        for i = 0, owned_regions:num_items() - 1 do
            ...
            if (region:name() == "wh3_main_combi_region_kings_glade" or region:name() == "wh3_main_combi_region_vauls_anvil_loren" or region:name() ==
                ...
                "wh3_main_combi_region_the_witchwood" or region:name() == "wh3_main_combi_region_gaean_vale" or region:name() == "wh3_main_combi_region_laurelorn_forest" or
                region:name() == "wh3_main_combi_region_gryphon_wood" or region:name() == "wh3_main_combi_region_forest_of_gloom" or region:name() ==
                "wh3_main_combi_region_oreons_camp" or region:name() == "wh3_main_combi_region_the_haunted_forest" or region:name() == "wh3_main_combi_region_jungles_of_chian" or
...
function(context)
    ...
    if current_faction_name ~= "rebels" then
        cm:callback(function()
            ...
            local effect_strength_construction = math.ceil(ai_buff_level * -3 * mod_construction * mod_extra_difficulty - 5)
            ...
            if (current_faction_name == "wh_main_emp_empire") or (current_faction_name == "wh_dlc07_vmp_von_carstein") then
                jlog("Turn: # " .. turn_number .. " |  Difficulty: " .. player_difficulty .. " | Player Score: " .. player_score .. "| AI Faction: " ..
                         tostring(current_faction_name) .. " | AI Buff Level: " .. ai_buff_level .. " | Income: " .. "+" .. effect_strength_tax_rate .. "%" .. " | Growth: " ..
                         "+" .. effect_strength_growth .. " | Construction Cost: " .. effect_strength_construction .. "%" .. " | Loot: " .. "+" .. effect_strength_battle_loot ..
                         "%" .. " | Rank: " .. "+" .. recruit_rank .. " | Unit XP Per Turn: " .. "+" .. xp_gain_per_turn .. " | Replenishment: " .. "+" .. replenishment_bonus ..
